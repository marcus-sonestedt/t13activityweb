# Generated by Django 2.2.10 on 2020-06-12 21:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='member',
            name='licenses',
            field=models.ManyToManyField(to='app.LicenseType', verbose_name='Licenser'),
        ),
        migrations.CreateModel(
            name='Driver',
            fields=[
                ...
                ('klass', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.CarClassification')),
